import { BarokeExplorer, MealBudgetLab } from "./baroque-explorer";

export function StudentEatsLanding() {
  return (
    <main className="baroque-shell">
      <header className="baroque-nav">
        <a className="baroque-brand" href="#top"><span>B</span><div><strong>BAROKE</strong><small>BARUCH STUDENT EATS</small></div></a>
      ...
      <section className="baroque-hero" id="top">
        ...
        <div className="hero-copy-block">
          ...
          <p className="baroque-intro">Baroke is the upcoming student food map for honest prices, student discounts, verified deals, and meals close enough to make before your next class.</p>
          <div className="baroque-actions"><a href="#preview">Preview Baroke <span>→</span></a><a href="/tracker">Open the inflation tracker</a></div>
        </div>
      ...
      <BarokeExplorer />
      <section className="product-boundary"><span>LIFEBETA MEASURES THE PROBLEM</span><i>→</i><span>BAROKE HELPS STUDENTS ACT</span></section>
      <footer className="baroque-footer"><a className="baroque-brand" href="#top"><span>B</span><div><strong>BAROKE</strong><small>POWERED BY LIFEBETA</small></div></a><p>Independent educational project · seeded restaurant preview · no active deal claims</p><a href="/tracker">Open LifeBeta tracker →</a></footer>
    </main>
  );
}
